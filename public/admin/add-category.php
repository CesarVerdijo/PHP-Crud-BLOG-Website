...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="col-md-6 mx-auto">
	            <form action="cat-save.php" method="post">
                <h1 class="h3 mb-2 fw-normal">Add Category</h1>
                	    <?php if (!empty($errors)):?>
...
<!-- category -->
      ...
      <!-- slug -->
	            <div class="form-floating my-2">
	                   <input class="form-control" name="slug" type="slug" id="floatingInput" placeholder="slug">
     ...
     <!-- enable -->
                          <div class="form-floating my-3">
                              <select name="enable" class="form-select">
                                ...
                                <label for="floatingInput">Enable</label>
                          </div>
