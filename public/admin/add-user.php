...
<!-- username -->
                    <div class="form-floating my-2">
                          <input class="form-control" name="username" type="usernamel" id="floatingInput" placeholder="Username">
...
<!-- email -->
	                     <div class="form-floating my-2">
	                   <input class="form-control" name="email" type="email" id="floatingInput" placeholder="name@example.com">
...
<!-- retypepass -->
                       <div class="form-floating my-2">
                        <input class="form-control" name="Retype-Password" type="password" id="floatingInput" placeholder="Retype-password">
