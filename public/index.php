...
<div class="container my-5">
  ...
  <div class="p-5 text-center bg-body-tertiary rounded-3">
    ...
    <h1 class="text-body-emphasis">Welcome to Everything Life</h1>
    <p class="col-lg-8 mx-auto fs-5 text-muted">
     Already have an account? Please Log in. <br>If not, you can create an account.
    </p>
    <div class="d-inline-flex gap-2 mb-5">
      ...
      <a href="signup.php" style="text-decoration: none; color: black;">Create an account</a>
      </button>
...
<div class="col-md-5 offset-md-1 mb-3">
        <form>
          ...
          <button class="btn btn-outline-secondary btn-lg px-2 rounded-pill" type="button">
      <a href="signup.php" style="text-decoration: none; color: black;">Subscribe</a>
      </button>
          </div>
        </form>
      </div>
